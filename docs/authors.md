...
Source:
[`DESCRIPTION`](https://github.com/migmontal/ebdt/blob/HEAD/DESCRIPTION)

Montero-Alonso M, Luna del Castillo J (2026). *ebdt: Evaluation of
Binary Diagnostic Test*. R package version 1.0.1,
